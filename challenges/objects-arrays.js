...
const universities = graduates
  .sort(({ university: uni }, { university }) =>
    uni > university ? 1 : uni < university ? -1 : 0
  )
...
*/
const displayNames = [];
zooAnimals.forEach(({animal_name, scientific_name}) => displayNames.push(`Name: ${animal_name}, Scientific: ${scientific_name}`))
